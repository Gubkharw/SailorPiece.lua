...
-- เพิ่มตัวแปรสำหรับระบบ Auto Vote
...
-- [[ ฟังก์ชันสนับสนุนเดิม (คงไว้ทั้งหมด) ]]
...
FarmTab:CreateDropdown({
   ...
   Options = {"CidDungeon", "RuneDungeon"},
   CurrentOption = {"None"},
...
Rayfield:Notify({Title = "GK Hub Ready", Content = "Auto Farm Tab Enabled"})